...
public class JsonLDObject {
    ...
    public static class Builder<B extends Builder<B>> {
        ...
        public JsonLDObject build() {
            ...
            if (this.contexts != null) {
                List<String> existingContexts = this.contexts.stream().map(JsonLDUtils::uriToString).collect(Collectors.toList());
                if (this.forceContextsArray) {
                    JsonLDUtils.jsonLdAddAsJsonArray(this.jsonLdObject, Keywords.CONTEXT, existingContexts);
                } else {
                    if(this.jsonLdObject.getContexts()==null || this.jsonLdObject.getContexts().isEmpty()){
                        JsonLDUtils.jsonLdAdd(this.jsonLdObject, Keywords.CONTEXT, existingContexts);
                    }else{
                        JsonLDUtils.jsonLdAddAsJsonArray(this.jsonLdObject, Keywords.CONTEXT, existingContexts);
                    }
                }
            ...
            if (this.types != null) if (this.forceTypesArray)
                JsonLDUtils.jsonLdAddAsJsonArray(this.jsonLdObject, JsonLDKeywords.JSONLD_TERM_TYPE, this.types);
            else JsonLDUtils.jsonLdAdd(this.jsonLdObject, JsonLDKeywords.JSONLD_TERM_TYPE, this.types);
            if (this.id != null)
    ...
    public static JsonLDObject fromJsonLDObject(JsonLDObject jsonLDObject) {
